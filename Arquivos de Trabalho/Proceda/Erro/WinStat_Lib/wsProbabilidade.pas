...
begin
  ...
  if Env then
    GetLimits(xInf,xSup,n); // Cria limites para o envelope
...
begin
  ...
  for i:=1 to k do
    ...
    wm:=0; yv:=0; n:=0; x3:=0; sum:=0; sum2:=0;
...
begin
  ...
  nx:= Fp-SucSize; // dimensao do complemento
  aux:= 0;
  L:= 0;
  Result.PrintOptions.ColWidth:=10;
  Result.PrintOptions.ColPrecision:=4;
